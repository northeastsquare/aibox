...
//HI_S32 SAMPLE_COMM_ISP_BindSns(ISP_DEV IspDev, SAMPLE_SNS_TYPE_E enSnsType, HI_S8 s8SnsDev);
HI_S32 SAMPLE_COMM_ISP_BindSns(ISP_DEV IspDev, HI_U32 u32SnsId, SAMPLE_SNS_TYPE_E enSnsType, HI_S8 s8SnsDev);
HI_S32 SAMPLE_COMM_ISP_Sensor_Regiter_callback(ISP_DEV IspDev, SAMPLE_SNS_TYPE_E enSnsType);
...
HI_S32 SAMPLE_COMM_VDEC_CHN_Start(HI_S32 chn, SAMPLE_VDEC_ATTR *pstSampleVdec);
HI_S32 SAMPLE_COMM_VDEC_CHN_Stop(HI_S32 chn);
#ifdef __cplusplus
#if __cplusplus
}
#endif
